class App {
    ...
    tileCon: HTMLDivElement;
    APIKey: string = '8de8f701a45ae7dd5ffc153e401f2619';

    constructor() {
        this.searchInp = <HTMLInputElement>document.getElementById('searchInp');
        this.searchBtn = <HTMLButtonElement>document.getElementById('searchBtn');
        this.tileCon = <HTMLDivElement>document.getElementById('tileCon');
